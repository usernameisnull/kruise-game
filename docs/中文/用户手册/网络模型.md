...
- 详细文档: https://support.huaweicloud.com/usermanual-cce/cce_10_0681.html
- 是否支持网络隔离：是。
...
- 为每个pod单独分配EIP
- 暴露的公网访问端口与容器中监听的端口一致，通过安全组管理
- 仅CCE Turbo集群支持: https://support.huaweicloud.com/usermanual-cce/cce_10_0284.html#section1
#### 网络参数
